...
import { VideoCallProps } from "@/interfaces/interface"
import {IconButton,Button,Dialog,DialogTitle,DialogContent,DialogActions,Paper,Box,Typography,Tooltip,CircularProgress,} from "@mui/material";
...
const VideoCall:React.FC<VideoCallProps> = ({
    ...
    useEffect(()=>{
        console.log(remoteStream?.getVideoTracks().length,"00000");
      ...
      {isVideoCallActive ? (
        ...
        >
          <Box position="relative" width="100%" height="100%">
            ...
            {isCalling && !callConnected && calling()}
